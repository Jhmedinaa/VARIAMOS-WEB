  ...
  <div id="app">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div id="AppMessage" class="alert alert-danger" role="alert" style="display: none">
          <span></span>
        </div>
              ...
              <div class="modal-wrapper">
                <div class="modal-container">
                  <content select=".modal-header">
                    <div id="main_modal_header" class="modal-header">
                      <h3></h3>
                    </div>
                  </content>
                  <div id="main_modal_body" class="modal-body"></div>
